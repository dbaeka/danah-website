...
const Test = () => {
    return (
        <DefaultLayout>
            ...
            <NormalHeader title="SQ Assessment"/>
                ...
                <div className="section">
                    <Container>
                        ...
                        <h5 className="description">
                            ...
                            <br/><br/>
                            SQ also gives an individual the ability to become more conscious of the lower motivations
                            ...
                            <table align="center" border="0" cellPadding="0" cellSpacing="0">
                                <tbody>
                                <tr>
                                    <td style={{paddingRight: "20px", textAlign: "center"}}>Pay in pounds sterling (GBP)
                        ...
                        <h5 className="description">
                            ...
                            The only thing that can change behavior driven by negative motivations is behavior driven
                            ...
                            Take the <strong>"Q&nbsp;Quiz" (SQ Assessment)</strong> on this website, which will help you&nbsp;become
