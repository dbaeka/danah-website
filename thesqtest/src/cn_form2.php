<?php
    ...
    if(isset($result)){
        $temp_employee_status = (($result['employee_status']== null)? "--choose--": $result['employee_status']);
        $temp_last_payment = (($result['last_payment']== null)? "--choose--": $result['last_payment']);
        $temp_occupation = (($result['occupation']== null)? "--choose--": $result['occupation']);
    }
?>
					...
					<div class="row w-100">
						<form class="w-100" action="submitForm.php" method="post">
                            ...
                            <div class="form-group " style="background-color: rgba(220,220,220,0.2); padding: 10px; border-radius: 20px;">
                                ...
                                <select class="form-control" id="last_payment" name="last_payment" required>
                                    <?php 
                            ...
                            <div class="form-group " style="background-color: rgba(220,220,220,0.2); padding: 10px; border-radius: 20px;">
						  	...
						  	<div class="float-right">
                                ...
                                <a href="cn_form.php?token=<?=$token?>" style="margin: 10px;">
